...
public final class FragmentMyordersBinding implements ViewBinding {
  ...
  private FragmentMyordersBinding(@NonNull LinearLayout rootView, @NonNull Button button,
  ...
  public static FragmentMyordersBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_myorders, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static FragmentMyordersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMyordersBinding((LinearLayout) rootView, button, button2);
    }
